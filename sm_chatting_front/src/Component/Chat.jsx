...
const Chat = ({ chatMsg, setchatMsg, client, content, setContent }) => {
 return (
  <section className="flex flex-col flex-auto border-l border-gray-800">
   ...
   <div className="chat-footer flex-none">{<ChatFooter client={client} content={content} setContent={setContent} />}</div>
  </section>
 );
};
