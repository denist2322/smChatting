...
const Sidebar = ({ listMsg, chatRoomId, setChatRoomId, userId }) => {
 ...
 return (
  <section className="flex flex-col flex-none w-24 overflow-auto transition-all duration-300 ease-in-out hover:w-64 group lg:max-w-sm md:w-2/5">
   ...
   <div className="flex-none p-4 search-box">{<SearchUser userId={userId} active={active} setActive={setActive} setChatRoomId={setChatRoomId} />}</div>
