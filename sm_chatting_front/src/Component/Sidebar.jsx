...
const Sidebar = ({ listMsg, setChatRoomId, client }) => {
 return (
  <section className="flex flex-col flex-none overflow-auto w-24 hover:w-64 group lg:max-w-sm md:w-2/5 transition-all duration-300 ease-in-out">
   ...
   <div className="contacts p-2 flex-1 overflow-y-scroll">{<ChatList listMsg={listMsg} setChatRoomId={setChatRoomId} client={client} />}</div>
  </section>
 );
};
