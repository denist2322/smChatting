...
const Sidebar = ({ listMsg, setChatRoomId, userId, setActive }) => {
 return (
  <section className="flex flex-col flex-none overflow-auto w-24 hover:w-64 group lg:max-w-sm md:w-2/5 transition-all duration-300 ease-in-out">
   ...
   <div className="active-users flex flex-row p-2 overflow-auto w-0 min-w-full">{<Users userId={userId} setActive={setActive} />}</div>
